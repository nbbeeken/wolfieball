...
//     */
//    public void exportCourseSite(Course courseToExport, Stage primaryStage, FileController f) throws Exception {
...
//        }
//        
//        String url = getPageURLPath(courseToExport, CoursePage.SCHEDULE);
//        
//        p = new ProgressDialog(primaryStage, f, url);
//
//        double increment = (courseToExport.getPages().size());
//        
//        
...
//                            
//                            this.updateMessage("Exporting... " + pages[pageIndex].name());
//                            this.updateProgress(ct,increment);//COUNTER FOR PAGES GENERATED
//                            
//                            
//                            Thread.sleep(500);
//                        } catch (IOException | InterruptedException ex) {
//                            Logger.getLogger(DraftSiteExporter.class.getName()).log(Level.SEVERE, null, ex);
//                        }
//
//                    }
//                }
...
//        
//        
//        p.getBar().progressProperty().bind(task.progressProperty());
//        p.getProgressPie().progressProperty().bind(task.progressProperty());
//        p.getProgresslabel().textProperty().bind(task.messageProperty());
//        p.show();
...
//        for (File cssFile1 : cssFiles) {
//            File cssFile = new File(cssDir + SLASH + cssFile1.getName());
//            Files.copy(cssFile1.toPath(), cssFile.toPath(), StandardCopyOption.REPLACE_EXISTING);
//        }
//
//        // AND THEN COPY THE IMAGES OVER
//        File baseImagesDir = new File(baseDir + "/" + IMAGES_DIR);
//        File[] imageFiles = baseImagesDir.listFiles();
//        for (File imageFile1 : imageFiles) {
//            File imageFile = new File(imagesDir + "/" + imageFile1.getName());
//            Files.copy(imageFile1.toPath(), imageFile.toPath(), StandardCopyOption.REPLACE_EXISTING);
//        }
//    }
//
...
//
//        ObservableList<Lecture> lecs = courseToExport.getLectures();
//        ArrayList<String> lectureNames = new ArrayList<>();
//        lecs.stream().forEach((l) -> {
//            int ses = l.getSessions();
//            while (ses > 0) {
//                lectureNames.add(l.getTopic());
//                ses--;
//            }
//        });
...
//
//                    if (courseToExport.getLectureDays().contains(countingDate.getDayOfWeek()) && lectureCounter - 1 < lectureNames.size()) {
//                        String lecture = lectureNames.get(lectureCounter - 1);
//
//                        //ADD THE TEXT TO THE LINK
//                        Element lectureNum = scheduleDoc.createElement(HTML.Tag.SPAN.toString());
//                        lectureNum.setTextContent("Lecture " + lectureCounter);
//                        lectureNum.setAttribute(HTML.Attribute.CLASS.toString(), CLASS_LECTURE);
//                        dayCell.appendChild(lectureNum);
//
//                        Element br0 = scheduleDoc.createElement(HTML.Tag.BR.toString());
//                        dayCell.appendChild(br0);
//
//                        Element lectureTopic = scheduleDoc.createElement(HTML.Tag.SPAN.toString());
//                        boolean match = lastLectureTitle.equals(lecture);
//                        lectureTopic.setTextContent(lecture + (match ? " (Continued)" : ""));
//                        dayCell.appendChild(lectureTopic);
//
//                        Element br1 = scheduleDoc.createElement(HTML.Tag.BR.toString());
//                        dayCell.appendChild(br1);
//
//                        lastLectureTitle = lecture;
//
//                        lectureCounter++;
//
//                    }
...
//
//                    // ADD A LINK
//                    Element hwSpanElement = scheduleDoc.createElement(HTML.Tag.SPAN.toString());
//                    hwSpanElement.setTextContent(assignment.getName());
//                    hwSpanElement.setAttribute(HTML.Attribute.CLASS.toString(), CLASS_HW);
//                    dayCell.appendChild(hwSpanElement);
//
//                    Element br = scheduleDoc.createElement(HTML.Tag.BR.toString());
//                    dayCell.appendChild(br);
//
//                    // ADD THE TEXT TO THE LINK
//                    Element hwDueTimeName = scheduleDoc.createElement(HTML.Tag.SPAN.toString());
//                    hwDueTimeName.setTextContent("Due @ 11:59pm " + "(" + assignment.getTopics() + ")");
//                    dayCell.appendChild(hwDueTimeName);
//
//                }
//
...
//        Node hwTable = getNodeWithId(hwsDoc, HTML.Tag.TABLE.toString(), "HWTable");
//
//        List<Assignment> assingments = courseToExport.getAssignments();
//
//        //240,240,255
//        int r = 240;
//        int g = 240;
//        int b = 255;
//
//        for (Assignment a : assingments) {
//
//            Element tablerow = hwsDoc.createElement(HTML.Tag.TR.toString());
//            tablerow.setAttribute(HTML.Attribute.STYLE.toString(), "background-color:rgb(" + r + "," + g + "," + b + ");\nheight: 2cm;");
//            //tablerow.setAttribute(HTML.Attribute.STYLE.toString(), "height: 2cm");
//
//            Element hwName = hwsDoc.createElement(HTML.Tag.TD.toString());
//            hwName.setAttribute(HTML.Attribute.CLASS.toString(), CLASS_HWS);
//            hwName.setTextContent(a.getName() + " - " + a.getTopics());
//
//            Element dueDate = hwsDoc.createElement(HTML.Tag.TD.toString());
//            dueDate.setAttribute(HTML.Attribute.CLASS.toString(), CLASS_HWS);
//            String date;
//            date = a.getDate().getDayOfWeek().toString();
//            date += " " + a.getDate().getMonthValue() + "/" + a.getDate().getDayOfMonth();
//            dueDate.setTextContent(date + " @ 11:59pm");
//
//            Element gradingRubric = hwsDoc.createElement(HTML.Tag.TD.toString());
//            gradingRubric.setAttribute(HTML.Attribute.CLASS.toString(), CLASS_HWS);
//            gradingRubric.setTextContent("TBD");
//
//            tablerow.appendChild(hwName);
//            tablerow.appendChild(dueDate);
//            tablerow.appendChild(gradingRubric);
//            hwTable.appendChild(tablerow);
//
//            r -= 10;
//            g -= 10;
//            b -= 5;
